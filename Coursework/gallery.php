...
<div class="container">
    ...
    <div class="container">
        ...
        ?>
            ...
            <div class="col-md-3">
                <ul class="row">
                    <li class="col-lg-2 col-md-2 col-sm-3 col-xs-4"> <center><img src="<?php echo $upload_dir . $row['image'] ?>" data-lity class="img-responsive"></center></li> <!-- display image from database -->
            </ul> <!-- end of row div -->
        </div>  <!-- end of col div -->
            <?php
            }
